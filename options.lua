...
local path = {
  ...
  wide_overlay   = config_path .. "images/wide_overlay.png",
}
...
local options = {
    ...
    wide_overlay = {
      enabled = utils.set { "wide" },
      utils.make_image {
        path = path.wide_overlay, depth = 0,
        dst = { post_anchor = { 0, 0 }, item_anchor = "center", w = 2560, h = 1440, }
      }
    },
	...
	mpk = {
		...
		-- uses [STATE OUTPUT] to detect loading into the world after the launch key was pressed
		load = "1"
	},
}
